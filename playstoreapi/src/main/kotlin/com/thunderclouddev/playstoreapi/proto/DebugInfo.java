...
public final class DebugInfo extends
        ...
        switch (tag) {
          ...
          case 19: {
            if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
              timing_ = new java.util.ArrayList<Timing>();
              mutable_bitField0_ |= 0x00000002;
            }
            timing_.add(input.readGroup(2, Timing.PARSER,
                extensionRegistry));
            break;
          }
        }
  ...
  protected FieldAccessorTable
    ...
    return GooglePlay.internal_static_DebugInfo_fieldAccessorTable
  ...
  public static final class Timing extends
    ...
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return GooglePlay.internal_static_DebugInfo_Timing_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
  ...
  private java.util.List<Timing> timing_;
  /**
   * <code>repeated group Timing = 2 { ... }</code>
   */
  public java.util.List<Timing> getTimingList() {
    return timing_;
  }
  /**
   * <code>repeated group Timing = 2 { ... }</code>
   */
  public java.util.List<? extends TimingOrBuilder>
  ...
  ensureMessageIsMutable();
    ...
    private void ensureTimingIsMutable() {
      if (!((bitField0_ & 0x00000002) == 0x00000002)) {
        timing_ = new java.util.ArrayList<Timing>(timing_);
        bitField0_ |= 0x00000002;
       }
    }
     ...
     */
    public Builder setTiming(
        int index, Timing.Builder builderForValue) {
      if (timingBuilder_ == null) {
        ensureTimingIsMutable();
     ...
     * <code>repeated group Timing = 2 { ... }</code>
     */
    public Builder addTiming(Timing value) {
      if (timingBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllTiming(
        Iterable<? extends Timing> values) {
      if (timingBuilder_ == null) {
        ensureTimingIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, timing_);
    ...
    public Timing.Builder addTimingBuilder(
        int index) {
      return getTimingFieldBuilder().addBuilder(
          index, Timing.getDefaultInstance());
    }
    /**
     * <code>repeated group Timing = 2 { ... }</code>
     */
    public java.util.List<Timing.Builder>
