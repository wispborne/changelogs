...
public interface BookDetailsOrBuilder extends
   ...
   * <code>repeated .BookSubject subject = 3;</code>
   */
  com.thunderclouddev.playstoreapi.proto.BookSubjectOrBuilder getSubjectOrBuilder(
      int index);
   ...
   */
  java.util.List<com.thunderclouddev.playstoreapi.proto.BookAuthor>
      getAuthorList();
  /**
   * <code>repeated .BookAuthor author = 9;</code>
   */
  com.thunderclouddev.playstoreapi.proto.BookAuthor getAuthor(int index);
  /**
   * <code>repeated .BookAuthor author = 9;</code>
   */
  int getAuthorCount();
   ...
   * <code>repeated .BookAuthor author = 9;</code>
   */
  java.util.List<? extends com.thunderclouddev.playstoreapi.proto.BookAuthorOrBuilder>
      getAuthorOrBuilderList();
  /**
   * <code>repeated .BookAuthor author = 9;</code>
   */
  com.thunderclouddev.playstoreapi.proto.BookAuthorOrBuilder getAuthorOrBuilder(
      int index);
   ...
   */
  java.util.List<com.thunderclouddev.playstoreapi.proto.BookDetails.Identifier>
      getIdentifierList();
  /**
   * <code>repeated group Identifier = 18 { ... }</code>
   */
  com.thunderclouddev.playstoreapi.proto.BookDetails.Identifier getIdentifier(int index);
  /**
   * <code>repeated group Identifier = 18 { ... }</code>
   */
   ...
   * <code>repeated group Identifier = 18 { ... }</code>
   */
  java.util.List<? extends com.thunderclouddev.playstoreapi.proto.BookDetails.IdentifierOrBuilder>
      getIdentifierOrBuilderList();
  /**
   * <code>repeated group Identifier = 18 { ... }</code>
   */
  com.thunderclouddev.playstoreapi.proto.BookDetails.IdentifierOrBuilder getIdentifierOrBuilder(
      int index);
}
